INSERT INTO identity (id, created, updated, version, city, latitude, longitude, street, street_number, zip_code, auth_provider, email, email_verified, external_id, given_name, phone, surname)
VALUES
